...
public class CommentController {
    ...
    public CommentDto getUserComment(@PathVariable @Positive Long userId,
        ...
        log.info("Calling GET: /users/{userId}/events/{eventId}/comments/{commentId} with 'userId': {}," +
    ...
    public List<CommentDto> getUserEventComments(@PathVariable @Positive Long userId,
        ...
        log.info("Calling GET: /users/{userId}/events/{eventId}/comments with 'userId': {}, 'eventId': {},",
                userId, eventId);
    ...
    public CommentDto updateUserComment(@PathVariable @Positive Long userId,
        ...
        log.info("Calling PATCH: /users/{userId}/events/{eventId}/comments/{commentId} with 'userId': {}," +
                " 'eventId': {}, 'commentId': {}, 'newCommentDto': {}", userId, eventId, commentId, newCommentDto);
    ...
    public void deleteUserComment(@PathVariable @Positive Long userId,
        ...
        log.info("Calling DELETE: /users/{userId}/events/{eventId}/comments/{commentId} with 'userId': {}," +
                " 'eventId': {}, 'commentId': {}", userId, eventId, commentId);
